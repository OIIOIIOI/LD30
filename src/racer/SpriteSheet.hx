...
class SpriteSheet {
	...
	public function new () {
		...
		tiles.set("next", createTile(new Rectangle(124, 80, 40, 40)));
		for (i in 0...3)	tiles.set("cockpit"+i, createTile(new Rectangle(198, i*30, 70, 30)));
		for (i in 0...5)	tiles.set("dash"+i, createTile(new Rectangle(198, 90+i*10, 70, 10)));
	}
